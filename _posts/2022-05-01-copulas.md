...
**Proof of Proposition 1.** Assume that $C$ is absolutely continuous, and let $g(w, z)$ be the density of $(U, V)$ and $G(z, w) = \mathbb{P}\{Z \leq z, W \leq w\}$, then
...
[^7]: Mohamed N. Jouini and Robert T. Clemen, Copula Models for Aggregating Expert Opinions, *Operations Research*, Vol. 44, No. 3 (1996), pp. 444-457.